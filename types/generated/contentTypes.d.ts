...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    header: Schema.Attribute.Media<'images' | 'videos'>;
    lectures: Schema.Attribute.Relation<'oneToMany', 'api::lecture.lecture'>;
    links: Schema.Attribute.Relation<'oneToMany', 'api::icon.icon'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::course.course'
...
export interface ApiLectureLecture extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['lecture', 'exercise', 'presentation', 'exam']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    icons: Schema.Attribute.Relation<'oneToMany', 'api::icon.icon'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::project.project'
...
export interface ApiResumeResume extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    institutions: Schema.Attribute.Relation<
      'oneToMany',
      'api::experience.experience'
    >;
    locale: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    socials: Schema.Attribute.Relation<'oneToMany', 'api::icon.icon'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workplaces: Schema.Attribute.Relation<
      'oneToMany',
      'api::experience.experience'
    >;
  };
...
export interface ApiSummarySummary extends Struct.SingleTypeSchema {
